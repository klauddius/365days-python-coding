...
def test_make_tile_examples_from_site():
    ...
    assert day13.make_title("i aM a tITLE") == "I AM A TITLE"
    assert day13.make_title(
        "the first letter of every word is capitalized") == "The First Letter Of Every Word Is Capitalized"
    ...
    assert day13.make_title(
        "Me and my wife lived happily for twenty years and then we met.") == "Me And My Wife Lived Happily For Twenty Years And Then We Met."
    assert day13.make_title(
        "There are no stupid questions, just stupid people.") == "There Are No Stupid Questions, Just Stupid People."
    assert day13.make_title(
        "1f you c4n r34d 7h15, you r34lly n33d 2 g37 l41d") == "1f You C4n R34d 7h15, You R34lly N33d 2 G37 L41d"
